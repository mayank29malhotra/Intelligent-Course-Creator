...
Note: Quality threshold is configured via the UI slider (default: 75%)
"""
...
class CourseCreatorApp:
    ...
    def _initialize_coordinator(self):
        """Initialize the coordinator with default configuration.
        Quality threshold will be set from UI input during course creation."""
        try:
            # Use default quality threshold - will be overridden by UI input
